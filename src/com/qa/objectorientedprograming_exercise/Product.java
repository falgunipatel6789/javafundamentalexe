...
public class Product {
	...
	/*
	 * 
	 * static String SELLERNAME = "falguni"; static int CONTACTNO = 0123456; static
	 * String EMAIL = "patel_sarin@yahoo.co.uk";
	 * 
	 * 
	 * Product() {
	 * 
	 * 
	 * id = 2; name = "mouse"; price = 201.50f; category = "asdf"; rating = 5;
	 * isAvailable = true;
	 * 
	 * }
	 */
